...
import type { InventoryItemMeta } from "../../../../../character/api/dto/response/InventoryItemMeta.js";
...
export const ItemDocumentSchema = SchemaFactory.createForClass(ItemDocument);
