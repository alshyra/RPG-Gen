...
import { ItemDefinition, ItemDefinitionDocument } from "../../infrastructure/persistence/mongo/schemas/ItemDefinition.js";
...
export class ItemDefinitionService {
  ...
  async findByDefinitionId(id: string): Promise<ItemDefinition | null> {
    return this.model.findOne({ definitionId: id }).exec();
  }
