...
export { ItemDefinition, ItemDefinitionSchema } from "./item/ItemDefinition.js";
export type { ItemSlot, ItemBonuses } from "./item/ItemDefinition.js";
...
export { Aptitude, AptitudeSchema } from "./aptitude/index.js";
export type { AptitudeTargetType, AptitudeCategory, AptitudeScaling } from "./aptitude/index.js";
