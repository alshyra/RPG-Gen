...
@Module({
  ...
  providers: [CharacterService, ItemDefinitionService, LevelUpService, SpellDefinitionService],
  exports: [CharacterService, ItemDefinitionService, LevelUpService, SpellDefinitionService],
})
