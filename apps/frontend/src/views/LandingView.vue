    ...
    <div class="max-w-4xl w-full text-center">
      ...
      <div class="grid md:grid-cols-3 gap-6 mb-12">
        <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg p-6">
          ...
          <h3 class="text-xl font-bold text-white mb-2">Récits générés par IA</h3>
        ...
        <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg p-6">
          <div class="text-4xl mb-3">🌍</div>
          <h3 class="text-xl font-bold text-white mb-2">Univers multiples</h3>
          <p class="text-slate-400">
        ...
        <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg p-6">
          ...
          <h3 class="text-xl font-bold text-white mb-2">Création de personnage</h3>
          <p class="text-slate-400">
