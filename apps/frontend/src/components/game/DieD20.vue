...
.d20-image:hover .d20-raster {
  transform: scale(1.15) translateY(-2px);
  transition: transform 0.18s ease;
}

/* critical success: green glow + soft pulse */
.crit-success .d20-image {
  animation: d20-pulse 1.4s ease-in-out infinite;
  filter: drop-shadow(0 12px 36px rgba(34, 197, 94, 0.45));
}
@keyframes d20-pulse {
  0%,
  100% {
...
.crit-fail .d20-image {
  animation: d20-shake 0.6s ease-in-out 0s 2;
