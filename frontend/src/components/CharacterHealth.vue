<template>
    <div class="health-root" :class="{ 'is-beating': beating }" role="img" :aria-label="`PV: ${displayedHp}`">
        <svg class="heart" viewBox="0 0 32 29.6" fill="currentColor" aria-hidden="true">
        ...
        <div class="hp-text">{{ displayedHp }}</div>
    </div>
</template>
