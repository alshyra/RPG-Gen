...
describe('UiInputCheckbox Component', () => {
  ...
  it('should be checked when modelValue prop is true', () => {
    cy.mount(UiInputCheckbox, { props: { modelValue: true } });
  ...
  it('should not be checked when checked prop is false', () => {
    cy.mount(UiInputCheckbox, { props: { checked: false } });
    cy.get('input[type="checkbox"]')
  ...
  it('should be disabled when disabled prop is true', () => {
    cy.mount(UiInputCheckbox, { props: { disabled: true } });
    cy.get('input[type="checkbox"]')
      .should('be.disabled');
  });

  it('should not be disabled when disabled prop is false', () => {
    cy.mount(UiInputCheckbox, { props: { disabled: false } });
    cy.get('input[type="checkbox"]')
  ...
  it('should render different sizes from props', () => {
    ...
    cy.get('[data-testid="ui-checkbox"] > span')
