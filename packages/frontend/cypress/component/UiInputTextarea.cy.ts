...
describe('UiInputTextarea Component', () => {
  ...
  it('should display the modelValue', () => {
    cy.mount(UiInputTextarea, { props: { modelValue: 'Test Content' } });
    cy.get('textarea')
  ...
  it('should accept placeholder prop', () => {
    cy.mount(UiInputTextarea, { props: { placeholder: 'Enter your description' } });
    cy.get('textarea')
      .should('have.attr', 'placeholder', 'Enter your description');
  });

  it('should be disabled when disabled prop is true', () => {
    cy.mount(UiInputTextarea, { props: { disabled: true } });
    cy.get('textarea')
      .should('be.disabled');
  });

  it('should not be disabled when disabled prop is false', () => {
    cy.mount(UiInputTextarea, { props: { disabled: false } });
    cy.get('textarea')
      .should('not.be.disabled');
  });

  it('should respect rows prop', () => {
    cy.mount(UiInputTextarea, { props: { rows: 5 } });
    cy.get('textarea')
