...
// The DiceRoll component now uses the global event bus for roll notifications.
// ChatBar no longer re-emits 'rolled' to its parent; GameView subscribes to the bus.
</script>
